...
export class ProductManager {
    ...
    async addProduct(object) {
        try {
            ...
            let exist = products.find(product => product.id == object.id )
            ...
            const product = new Product( id, object.title, object.description, object.price, object.stock, object.category, object.thumbnails )
